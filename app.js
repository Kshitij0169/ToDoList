...
mongoose.connect("mongodb+srv://tiwariks:tiwariks01@webd.k7yrcnk.mongodb.net/todolistDB?retryWrites=true&w=majority")
...
const item3 = new Item({
  name: " <- Hit this to delete a selected item."
});
